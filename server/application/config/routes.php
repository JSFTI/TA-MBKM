...
$route['api/products/(:num)/thumbnail']['put'] = 'Panel/Product/ThumbnailController/update/$1';
$route['api/products/(:num)/thumbnail']['delete'] = 'Panel/Product/ThumbnailController/destroy/$1';
